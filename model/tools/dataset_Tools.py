...
stopwords = pd.read_table("/Users/yul/Desktop/기업프로젝트/wisenut_demo/tools/korean100.txt", sep="\t")
stopwords = stopwords.iloc[:,0].tolist()
with open("/Users/yul/Desktop/기업프로젝트/wisenut_demo/tools/inverted_index.pickle", "rb") as f:
